...
<script lang="ts" setup>
  ...
  import { userGetDetailApi } from '/@/api/authorization/user';
  import { UserVo } from '/@/api/authorization/model/userModel';
  ...
  userGetDetailApi(userId.value).then((data: UserVo) => {
    user.value = data
  });
